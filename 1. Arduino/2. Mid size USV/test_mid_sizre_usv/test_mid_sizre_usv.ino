...
void loop(){
  ...
  // SETTING MODE
    ...
    Serial.print("; ");
    Serial.print(pulseIn(pin_mode, HIGH));
    Serial.print("; ");       
  ...
  // UDP RECIEVE TARGET COORDINATES
    ...
    // COMPASS
      ...
      if (compass_reading>= 180)
        compass_reading = map_float(compass_reading, 180, 360, 0, 180);
      else
        compass_reading = map_float(compass_reading, 0, 180, 180, 360);
